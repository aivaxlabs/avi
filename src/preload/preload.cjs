...
contextBridge.exposeInMainWorld('chatApp', {
  ...
  notes: {
    get: (payload) => invoke('notes:get', payload),
    uploadAttachment: (payload) => invoke('notes:upload-attachment', payload),
    lists: (payload) => invoke('notes:lists', payload),
    saveList: (payload) => invoke('notes:save-list', payload),
    deleteList: (payload) => invoke('notes:delete-list', payload),
    search: (payload) => invoke('notes:search', payload),
    save: (payload) => invoke('notes:save', payload),
    reorder: (payload) => invoke('notes:reorder', payload),
    generate: (payload) => invoke('notes:generate', payload),
    addAttachment: (payload) => invoke('notes:add-attachment', payload),
    readAttachment: (payload) => invoke('notes:read-attachment', payload),
    pickAttachments: (payload) => invoke('notes:pick-attachments', payload),
    exportAttachment: (payload) => invoke('notes:export-attachment', payload),
    onChanged: (callback) => subscribe('notes:changed', callback),
  },
  shortcuts: {
  ...
  plugins: {
    ...
    installChromeExtension: () => invoke('plugins:install-chrome-extension'),
